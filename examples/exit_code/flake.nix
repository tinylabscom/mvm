{
  ...
  # E2E run of `mvmctl machine run --flake ./examples/exit_code` must exit 7.
  # Adding `--timeout` declares a wall-clock grant, which a backend that cannot
  # enforce one (Firecracker) refuses at admission instead of running.
  #
