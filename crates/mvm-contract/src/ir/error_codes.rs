...
pub enum ErrorCode {
    ...
    NetworkWildcard,
    NetworkInvalidPort,
    IngressInvalidMapping,
    IngressDuplicateMapping,
    IngressDuplicateBind,
    IngressGuestNotLoopback,
    IngressUnsupportedTransform,
    InvalidId,
    UnpinnedDeps,
    LockfileNotFound,
...
impl ErrorCode {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            Self::NetworkInvalidPort => "E_NETWORK_INVALID_PORT",
            Self::IngressInvalidMapping => "E_INGRESS_INVALID_MAPPING",
            Self::IngressDuplicateMapping => "E_INGRESS_DUPLICATE_MAPPING",
            Self::IngressDuplicateBind => "E_INGRESS_DUPLICATE_BIND",
            Self::IngressGuestNotLoopback => "E_INGRESS_GUEST_NOT_LOOPBACK",
            Self::IngressUnsupportedTransform => "E_INGRESS_UNSUPPORTED_TRANSFORM",
            ...
            Self::ShellEntrypointForbidden => "E_SHELL_ENTRYPOINT_FORBIDDEN",
...
mod tests {
    ...
    fn every_variant_has_stable_string() {
        let all = [
            ...
            ErrorCode::NetworkInvalidPort,
            ErrorCode::IngressInvalidMapping,
            ErrorCode::IngressDuplicateMapping,
            ErrorCode::IngressDuplicateBind,
            ErrorCode::IngressGuestNotLoopback,
            ErrorCode::IngressUnsupportedTransform,
            ErrorCode::InvalidId,
            ...
            ErrorCode::ShellEntrypointForbidden,
