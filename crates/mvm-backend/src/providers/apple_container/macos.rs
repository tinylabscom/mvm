...
pub fn start_vm(
    ...
    cpus: u32,
    memory_mib: u64,
    verity: Option<crate::providers::apple_container::VerityConfig<'_>>,
) -> Result<(), String> {
    ensure_signed();
...
mod tests {
    ...
    fn test_listener_recovers_from_stale_socket_and_reads_port() {
        with_temp_home(|_home| {
            ...
            client
                .write_all(&crate::providers::apple_container::GUEST_AGENT_PORT.to_le_bytes())
                .expect("write port");
    ...
    fn test_proxy_port_allowlist() {
        ...
        assert!(proxy_port_is_allowed(
            crate::providers::apple_container::GUEST_AGENT_PORT
        ));
        ...
        assert!(!proxy_port_is_allowed(
            crate::providers::apple_container::GUEST_AGENT_PORT - 1
        ));
        assert!(!proxy_port_is_allowed(
            crate::providers::apple_container::GUEST_AGENT_PORT + 1
        ));
    ...
    fn start_vm_rejects_short_roothash() {
        ...
        let cfg = crate::providers::apple_container::VerityConfig {
            verity_path: &v,
            roothash: "deadbeef",
            initrd_path: &i,
        };
