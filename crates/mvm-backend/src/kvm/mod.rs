...
//! implementing the [`crate::vmm::hv`] seam.
//!
...
// KVM — which reuses the whole arm64 device model — is a later slice.
#[cfg(all(target_os = "linux", target_arch = "x86_64"))]
pub mod vm;
#[cfg(all(target_os = "linux", target_arch = "x86_64"))]
pub use vm::{
    KvmEgressResult, KvmError, KvmHandle, KvmVcpu, KvmVm, VSOCK_IRQ, VSOCK_MMIO_BASE,
