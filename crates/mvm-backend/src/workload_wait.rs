...
//! (libkrun or legacy_macos) persists `workload.exit` BEFORE the guest powers off — the
...
/// timeout elapses (→ UNKNOWN). Shared by the libkrun and legacy_macos `VmBackend::wait`
