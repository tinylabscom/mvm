...
use mvm_vmm::vsock_egress_bridge::egress_gate::{DnsVerdict, EgressGate, EgressVerdict, Route};
    ...
    fn admit_open_tcp(
        ...
        match decision.verdict {
            ...
            EgressVerdict::Deny(reason) => {
                ...
                self.deny_flow(stream_id, &flow, "policy_denied");
                Ok(None)
            }
    ...
    fn substitution_binding(
        ...
        if with_intermediate {
            ...
            service = service.with_tls_intermediate(
                ca.mint_vm_intermediate(&[bound_host])
