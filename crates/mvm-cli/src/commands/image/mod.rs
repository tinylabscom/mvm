...
pub(in crate::commands) fn resolve_or_pull_run_image(
    ...
    crate::commands::env::dev_vm::sweep_orphaned_vm_helpers_on_startup();
...
#[cfg(test)]
mod tests {
    use super::trust::CosignVerifyError;
    use super::*;
...
"#,
    ...
    fn registry_env_key_normalizes_registry_host() {
        assert_eq!(trust::registry_env_key("ghcr.io").expect("key"), "GHCR_IO");
        assert_eq!(
            trust::registry_env_key("registry.example.test:5000").expect("key"),
    ...
    fn registry_auth_prefers_registry_specific_bearer_token() {
        ...
        let auth = trust::registry_auth_from_lookup(&image_ref, |name| match name {
    ...
    fn registry_auth_has_no_docker_config_dependency() {
        ...
        let auth = trust::registry_auth_from_lookup(&image_ref, |name| {
