...
pub use api::{
    ...
    mount_volume_on, ping, ping_at, post_restore_at, post_restore_with_grant_at, query_fs_diff,
    query_fs_diff_at, query_fs_diff_on, query_integration_status, query_integration_status_at,
    query_primed_at, query_probe_status, query_probe_status_at, query_worker_status,
...
pub use connection::{
    HOST_CID, connect_host_vsock, connect_to, connect_to_port, send_request, try_connect_once,
    vsock_uds_path,
};
pub use framing::{
