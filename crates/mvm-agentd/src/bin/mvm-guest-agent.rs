...
use mvm_agentd::lifecycle_hooks::{self, ReadinessConfig};
use mvm_agentd::probes::{self, ProbeEntry, ProbeOutputFormat, ProbeResult};
...
static GENID_RESEEDER: Mutex<mvm_agentd::genid::GenIdReseeder> = Mutex::new(
...
mod tests {
    ...
    use mvm_agentd::integrations::{IntegrationEntry, IntegrationHealthResult, IntegrationStatus};
