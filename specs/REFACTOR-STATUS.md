...
5. Keep Plan 189 closed; the shared Vz live lane now has detached-workload visibility plus post-PID fail-fast. Next rerun the macOS `examples/sleeper` resident proof, then public `vm save`/`vm restore` and pinned-base checkpoint/fork content proof.
