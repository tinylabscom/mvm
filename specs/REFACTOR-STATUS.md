...
- [ ] **PLAN 125** — CLI surface + SDK DX veneer · 🟢 Phase A done (via Plan 178); B1a Sandbox copy + B1b forward/ports landed in **both** Python + TS SDKs (forward = detached background proxy, torn down on kill); B2 async, B3 lifecycle, C helpers, D TS parity, E cross-cutting remain
