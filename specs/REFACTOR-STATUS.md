...
5. Keep Plan 189 closed; the only remaining Vz work from the macOS-26 live lane is shared validation/fix work: make detached Vz workloads stay registered/running long enough for public `vm save`/`vm restore`, then rerun the alias round-trip and pinned-base checkpoint/fork content proof.
