...
- [ ] **PLAN 125** — CLI surface + SDK DX veneer · 🟢 **Phase B complete** + D1 TS `exec` parity + **C1 `CodeSandbox`** (code-runner preset: run/run_script/install_package over Sandbox.exec) in **both** SDKs; C2 browser preset, Phase E cross-cutting remain
