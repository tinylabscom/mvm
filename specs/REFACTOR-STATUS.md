...
PLAN 189 — VZ DX parity (post-convergence)        🟡 in progress  (ADR-076 §"Out of scope")
  ...
  [~] WS-4 base pinning — design + Vz `dev up --base` resolution landed
      (template/slot/bundle refs, exact template/slot revision pins,
      fail-closed artifact checks, no parallel registry); live pinned-base
