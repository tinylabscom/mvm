...
- [ ] **Unconditional builder capabilities — issue #3322.**
      ...
      gated, repository, and BDD validation is green; queued delivery remains.
...
- [ ] **Image release-train repository extraction.**
      ...
      - [x] W5b #3364 (tinylabscom/mvm-images#6): `--override-input mvm
            path:<checkout>`, `build-host-binaries.sh --mvm-checkout`, and a
            local-manifest emitter whose producer is `local_checkouts` only.
      ...
      - [x] W5f #3364: the builder VM reads the selector — a selected
