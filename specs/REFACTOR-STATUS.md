...
PLAN 213 — Attested fast-first-boot packs   🟢 IN PROGRESS (ADR-097)
  ...
  [~] Workstream E — Runtime pack launch path.
      ...
      setup-cache misses, and malformed ready reports. Remaining: per-run CoW
      sandboxes, snapshot derivation, warm-claim/snapshot/cold launch binding,
      guest-agent command dispatch, secret-injection ordering tests, and live
      latency evidence.)
