...
PLAN 213 — Attested fast-first-boot packs   🟢 IN PROGRESS (ADR-097)
  ...
  [~] Workstream D — Install and prepare UX.
      ...
      preparation, and manifest sources. Remaining: install-time/default pack
      preparation, full launch-path pack consumption, policy-refusal CLI
      integration coverage, and snapshot/warm derivation.)
