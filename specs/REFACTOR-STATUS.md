...
PLAN 213 — Attested fast-first-boot packs   🟢 IN PROGRESS (ADR-097)
  ...
  [~] Workstream I — Revocation, mirrors, and offline policy.
      ...
      pins; verifier-level key-rotation windows; mirror identity checks; and
      prepare/cache/bootstrap CLI policy inputs. Remaining: revocation metadata
      fetching/freshness, enterprise mirror source resolution, stale-revocation
      offline behavior, and full revocation/mirror docs.)
