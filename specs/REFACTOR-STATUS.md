...
- [ ] **PLAN 125** — CLI surface + SDK DX veneer · 🟢 Phase A done (via Plan 178); B1 copy + forward/ports + D1 TS `exec` + B2 async surface landed in **both** SDKs (Python `aexec`/`async with`; TS `await using`); B3 lifecycle, C helpers, E cross-cutting remain
