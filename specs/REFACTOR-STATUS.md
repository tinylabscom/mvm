...
- [ ] **PLAN 118** — Supervisor standby pool · 🟡 **vz + libkrun DONE** (saved-standby warm pool live-validated + self-replenish #840 + overshoot flock closed); the only open box is the **non-vz** FC standby pool (the mvmd-facing deliverable)
...
PLAN 200 — Machine UX/DX layer  🔴 planned, docs strategy synced
  ...
  `mvm.toml` schema v2, local image inputs, scenario-led docs with explicit
