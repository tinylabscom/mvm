...
- [ ] **PLAN 124** — Lean guest agent · 🟡 ~70%; D1.2a protocol type stubs + check-stubs CI-gated (Plan 128 C3 Step 2) + D1.2 Step 2a contract + Step 2b contract-checked RPC client; CLI call-site migration (2c) + signed on-device config remain
