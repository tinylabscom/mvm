...
- [ ] **PLAN 124** — Lean guest agent · 🟡 ~65%; D1.2a protocol type stubs landed (protocol-v0.json → Python/TS, drift-checked); RPC method surface + signed on-device config remain
