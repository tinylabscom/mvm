...
PLAN 213 — Attested fast-first-boot packs   🟢 IN PROGRESS (ADR-097)
  ...
  [~] Workstream I — Revocation, mirrors, and offline policy.
      ...
      offline revocation freshness refusal; and prepare/cache/bootstrap CLI
      policy inputs. Remaining: network revocation metadata fetching,
