...
- [ ] **PLAN 125** — CLI surface + SDK DX veneer · 🟢 Phase A done (via Plan 178); B1 copy + forward/ports + D1 TS `exec` parity landed in **both** Python + TS SDKs; B2 async, B3 lifecycle, C helpers, E cross-cutting remain
