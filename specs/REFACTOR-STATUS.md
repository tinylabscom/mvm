...
- [ ] **PLAN 125** — CLI surface + SDK DX veneer · 🟢 Phase A done (via Plan 178); B1a Sandbox copy (copy_in/out) landed in **both** Python + TS SDKs; B1b ports/forward, B2 async, B3 lifecycle, C helpers, D TS parity, E cross-cutting remain
