...
| 5  | Vsock framing + supervisor-config JSON + datapath ingress are fuzzed | ci:fuzz_guest_request, ci:fuzz_authenticated_frame, ci:fuzz_supervisor_config, ci:fuzz_datapath_ingress | cargo-fuzz (ADR-001 §W4.1/W4.2) | Shipped |
