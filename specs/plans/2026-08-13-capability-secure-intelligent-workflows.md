...
- [ ] Reservation expiry/recovery that first verifies no live effect.
...
- [ ] The vertical slice verifies a fully compromised controller can consume only
...
- [ ] The receipt attests admitted/executed provenance, not semantic correctness
      of an AI result.
...
- [ ] Reservation and attempt state remain until live side effects are verified
      absent.
...
- [ ] User/operator/security documentation describes both commitments and
...
The transactional ledger records that capacity is available.
