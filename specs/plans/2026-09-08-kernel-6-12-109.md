...
- [x] Pass the Linux builder-VM Nix evaluation and kernel-build checks.
- [x] Record the completed implementation in the sprint and refactor rollup.
- [x] Merge the tested pull request and close #3213 through its linkage.
...
PR #3214 merged as `1c8d5154c3` after both native kernel builds, Nix
evaluation, the tree-built guest boot, and the full merge-group matrix passed.
Its issue linkage closed #3213.
