...
- [ ] **Step 2 — STILL DEFERRED:** the **libkrun** gvproxy/passt provider impl (a separate mechanism — `microvm_nix.rs` does bridge+tap with no iptables) and the claims-gated **mvm-hostd firewall/L4/L7 lift** (A2 enforce / A3 / A4) — witness-by-witness, see the deferred follow-ups.
