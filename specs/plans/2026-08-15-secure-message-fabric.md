...
- [x] ADR number assigned: ADR-046 (`specs/adrs/046-secure-message-fabric.md`).
- [x] Plan named by slug (`specs/plans/2026-08-15-secure-message-fabric.md`); no number claimed.
...
- [ ] Add ADR-046 and this plan cross-references to the current sprint/status
...
- [ ] Archive-before-purge is crash-tested.
