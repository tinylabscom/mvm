#!/usr/bin/env python3
# /// mvm function-entrypoint wrapper (Python). ADR-0009 / plan-0003.
# ///
...
"""mvm function-entrypoint wrapper for Python workloads.
...
input. Set `MVM_WRAPPER_ALLOW_REENTRY=1` to opt out of the safety
...
def main() -> int:
    ...
    if _main_invoked and os.environ.get("MVM_WRAPPER_ALLOW_REENTRY") != "1":
