...
**Reference design:** `public/docs/superpowers/specs/2026-06-03-install-download-experience-design.md`.
...
gh pr create --title "Install & download experience: install.sh, Homebrew tap, kernel/release docs, compile logging" --body "Implements public/docs/superpowers/specs/2026-06-03-install-download-experience-design.md"
```
