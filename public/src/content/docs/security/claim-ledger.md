...
| `cold-mode-snapshot-recovery` | Preview | Firecracker sealed pause/resume and pool Sleeping/Running paths exist, but docs must name backend support and restore semantics before claiming broader checkpoint recovery. |
