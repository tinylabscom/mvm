...
Override with `--hypervisor firecracker`, `--hypervisor hvf`, `--hypervisor qemu`, or `--hypervisor docker`. (The Apple Virtualization.framework backend has since been removed; HVF is the macOS 26+ default.)
