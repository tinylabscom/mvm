...
The HVF backend is the macOS 26+ Apple Silicon default (Hypervisor.framework, vsock-only egress). libkrun is also treated as an Apple Silicon macOS path for mvm support purposes.
