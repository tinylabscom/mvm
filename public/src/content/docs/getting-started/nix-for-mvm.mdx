...
Because the image is assembled in memory, a two-part mount is capped at 2 GiB
of regular-file data and refuses a larger tree rather than risking the host
killing `mvmctl`. Mount a narrower directory, or stage a copy that excludes
generated trees like `target/`.
