...
| Command                                  | Description                                                                                                                                                    |
| ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `mvmctl build sdk-sidecar build`         | Build the current checkout's glibc host-services sidecar inside the Stage 0 builder VM and install it into the version/architecture cache with source provenance |
