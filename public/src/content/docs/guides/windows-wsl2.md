...
- **Filesystem is real Linux ext4**. APFS-style copy-on-write is not available here; WSL2's ext4 falls back to byte-copy in `mvm-runtime::vm::cow::reflink_or_copy`, but everything functionally works.
