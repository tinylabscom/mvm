...
capability now lives under `crates/mvm-sdk/`, `crates/mvm-sdk/python/mvm/`, and
`crates/mvm-sdk/typescript/`. There is no longer a cross-repo boundary; one
...
| Python SDK (`@mv.func`)            | `crates/mvm-sdk/python/mvm/` (`@mvm.app`)                             |
| TypeScript SDK                     | `crates/mvm-sdk/typescript/`                                          |
